...
var css_248z$2 = ".box-module_box__B9p1f {\n  box-sizing: \"border-box\";\n  min-width: 0;\n}";
var styles$2 = {"box":"box-module_box__B9p1f"};
styleInject(css_248z$2);

var DsBox = function (_a) {
    var children = _a.children;
    return React.createElement("div", { className: styles$2.box }, children);
};

var css_248z$1 = ".button-module_ds-button__cynzi {\n  border-style: none;\n  position: relative;\n  cursor: pointer;\n  display: flex;\n  vertical-align: middle;\n  padding-top: var(--ds-space-2);\n  padding-bottom: var(--ds-space-2);\n  padding-left: var(--ds-space-7);\n  padding-right: var(--ds-space-7);\n  border-radius: var(--ds-border-radius-m);\n}\n.button-module_ds-button--primary__TBI1O {\n  background-color: var(--ds-color-ui-primary);\n  color: var(--ds-color-text-inverse);\n}\n.button-module_ds-button--primary__TBI1O svg {\n  color: var(--ds-color-text-inverse);\n}\n.button-module_ds-button--primary__TBI1O:hover {\n  background-color: var(--ds-color-brand-primary-main);\n}\n.button-module_ds-button--primary__TBI1O:active, .button-module_ds-button--primary__TBI1O:focus {\n  background-color: var(--ds-color-brand-primary-dark);\n}\n.button-module_ds-button--primary__TBI1O:disabled {\n  background-color: var(--ds-color-ui-disabled);\n  color: var(--ds-color-text-inverse);\n}\n.button-module_ds-button--secondary__BWF1O {\n  background-color: var(--ds-color-text-inverse);\n  border-color: var(--ds-color-ui-primary);\n  color: var(--ds-color-ui-primary);\n}\n.button-module_ds-button--secondary__BWF1O svg {\n  color: var(--ds-color-ui-primary);\n}\n.button-module_ds-button--secondary__BWF1O:hover {\n  color: var(--ds-color-text-inverse);\n  background-color: var(--ds-color-brand-primary-main);\n}\n.button-module_ds-button--secondary__BWF1O:active, .button-module_ds-button--secondary__BWF1O:focus {\n  color: var(--ds-color-text-inverse);\n  background-color: var(--ds-color-brand-primary-dark);\n}\n.button-module_ds-button--secondary__BWF1O:disabled {\n  background-color: var(--ds-color-ui-disabled);\n  color: var(--ds-color-text-inverse);\n}\n.button-module_ds-button--chevron__8g0Y9 {\n  background-color: transparent;\n  border-color: transparent;\n  color: var(--ds-color-ui-primary);\n}\n.button-module_ds-button--chevron__8g0Y9 svg {\n  color: var(--ds-color-ui-primary);\n}\n.button-module_ds-button--chevron__8g0Y9:hover {\n  color: var(--ds-color-brand-primary-main);\n}\n.button-module_ds-button--chevron__8g0Y9:active, .button-module_ds-button--chevron__8g0Y9:focus {\n  color: var(--ds-color-brand-primary-dark);\n}\n.button-module_ds-button--chevron__8g0Y9:disabled {\n  color: var(--ds-color-ui-disabled);\n}\n.button-module_ds-button--icon__Ne61r {\n  background-color: var(--ds-color-ui-primary);\n  border-color: transparent;\n  color: var(--ds-color-text-inverse);\n  padding-top: var(--ds-space-3);\n  padding-bottom: var(--ds-space-3);\n  padding-left: var(--ds-space-3);\n  padding-right: var(--ds-space-3);\n}\n.button-module_ds-button--icon__Ne61r svg {\n  color: var(--ds-color-text-inverse);\n}\n.button-module_ds-button--icon__Ne61r:hover {\n  background-color: var(--ds-color-brand-primary-main);\n}\n.button-module_ds-button--icon__Ne61r:active, .button-module_ds-button--icon__Ne61r:focus {\n  background-color: var(--ds-color-brand-primary-dark);\n}\n.button-module_ds-button--icon__Ne61r:disabled {\n  background-color: var(--ds-color-ui-disabled);\n  color: var(--ds-color-text-inverse);\n}\n.button-module_ds-button--small__qwoOF {\n  font-size: var(--ds-typography-scale-s);\n  padding-left: var(--ds-space-5);\n  padding-right: var(--ds-space-5);\n}\n.button-module_ds-button--medium__upFwA {\n  font-size: var(--ds-typography-scale-m);\n}\n.button-module_ds-button--large__7qlid {\n  font-size: var(--ds-typography-scale-l);\n  padding-left: var(--ds-space-9);\n  padding-right: var(--ds-space-9);\n}";
var styles$1 = {"ds-button":"button-module_ds-button__cynzi","ds-button--primary":"button-module_ds-button--primary__TBI1O","ds-button--secondary":"button-module_ds-button--secondary__BWF1O","ds-button--chevron":"button-module_ds-button--chevron__8g0Y9","ds-button--icon":"button-module_ds-button--icon__Ne61r","ds-button--small":"button-module_ds-button--small__qwoOF","ds-button--medium":"button-module_ds-button--medium__upFwA","ds-button--large":"button-module_ds-button--large__7qlid"};
styleInject(css_248z$1);

var selector$1 = 'ds-button';
var DsButton = function (props) {
    var classesArray = "".concat(selector$1, ",").concat(selector$1, "--").concat(props.variant || 'primary', ",").concat(selector$1, "--").concat(props.size || 'medium').split(',');
    var classNames = classesArray.map(function (n) { return styles$1[n]; }).toString().replace(/,/g, ' ');
    return React.createElement("button", { onClick: props.onClick, className: classNames, disabled: props.disabled }, props.label);
};

var css_248z = ".tag-module_ds-tag__GUiFs {\n  height: fit-content;\n  display: inline-block;\n  padding: var(--ds-space-1) var(--ds-space-2);\n  white-space: nowrap;\n  border-radius: var(--ds-border-radius-m);\n  border-style: solid;\n  border-width: 1px;\n  font-size: 11px;\n  border-color: transparent;\n}\n.tag-module_ds-tag--primary--solid__Z0UPy {\n  background-color: var(--ds-color-ui-primary);\n  color: var(--ds-color-text-inverse);\n}\n.tag-module_ds-tag--primary--outline__LtYjN {\n  border-color: var(--ds-color-ui-primary);\n  color: var(--ds-color-ui-primary);\n}\n.tag-module_ds-tag--secondary--solid__UqXc- {\n  background-color: var(--ds-color-brand-primary-main);\n  color: var(--ds-color-text-inverse);\n}\n.tag-module_ds-tag--secondary--outline__AXo3k {\n  border-color: var(--ds-color-brand-primary-main);\n  color: var(--ds-color-brand-primary-main);\n}\n.tag-module_ds-tag--error--solid__qFn4S {\n  background-color: var(--ds-color-ui-error-default);\n  color: var(--ds-color-text-inverse);\n}\n.tag-module_ds-tag--error--outline__LF1nQ {\n  border-color: var(--ds-color-ui-error-default);\n  color: var(--ds-color-ui-error-default);\n}\n.tag-module_ds-tag--success--solid__u8h59 {\n  background-color: var(--ds-color-ui-success-default);\n  color: var(--ds-color-text-inverse);\n}\n.tag-module_ds-tag--success--outline__4ygdL {\n  border-color: var(--ds-color-ui-success-default);\n  color: var(--ds-color-ui-success-default);\n}\n.tag-module_ds-tag--alert--solid__yroBa {\n  background-color: var(--ds-color-ui-alert-default);\n  color: var(--ds-color-text-inverse);\n}\n.tag-module_ds-tag--alert--outline__U5XlG {\n  border-color: var(--ds-color-ui-alert-default);\n  color: var(--ds-color-ui-alert-default);\n}";
var styles = {"ds-tag":"tag-module_ds-tag__GUiFs","ds-tag--primary--solid":"tag-module_ds-tag--primary--solid__Z0UPy","ds-tag--primary--outline":"tag-module_ds-tag--primary--outline__LtYjN","ds-tag--secondary--solid":"tag-module_ds-tag--secondary--solid__UqXc-","ds-tag--secondary--outline":"tag-module_ds-tag--secondary--outline__AXo3k","ds-tag--error--solid":"tag-module_ds-tag--error--solid__qFn4S","ds-tag--error--outline":"tag-module_ds-tag--error--outline__LF1nQ","ds-tag--success--solid":"tag-module_ds-tag--success--solid__u8h59","ds-tag--success--outline":"tag-module_ds-tag--success--outline__4ygdL","ds-tag--alert--solid":"tag-module_ds-tag--alert--solid__yroBa","ds-tag--alert--outline":"tag-module_ds-tag--alert--outline__U5XlG"};
styleInject(css_248z);

var selector = 'ds-tag';
var DsTag = function (props) {
    var classesArray = "".concat(selector, ",").concat(selector, "--").concat(props.type || 'primary', "--").concat(props.variant || 'solid').split(',');
    var classNames = classesArray.map(function (n) { return styles[n]; }).toString().replace(/,/g, ' ');
    return React.createElement("span", { className: classNames }, props.label);
};

function changeTheme(tokens) {
